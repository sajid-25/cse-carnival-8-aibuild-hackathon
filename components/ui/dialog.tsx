...
export function DialogContent({
  ...
  return (
    <div
      className={cn(
        "relative w-full rounded-xl border bg-card p-6 text-card-foreground shadow-2xl transition-all duration-200 animate-in fade-in-0 zoom-in-95 max-h-[90vh] overflow-y-auto",
        className
      )}
      {...props}
    >
...
export function DialogFooter({
  ...
  return (
    <div
      className={cn(
        "flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 pt-4 border-t mt-4 gap-2 sm:gap-0",
        className
      )}
      {...props}
    />
